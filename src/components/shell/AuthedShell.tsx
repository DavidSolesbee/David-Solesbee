 ...
 * appear). Each authorized module links to its analytics page; AI Insights is
 * still a preview until its milestone.
 */
...
const MODULE_NAV: Array<{ perm: string; label: string; href: string | null }> = [
  ...
  { perm: "module.ai_insights", label: "AI Insights", href: null },
];
      ...
      <header className="sticky top-0 z-40 border-b border-line bg-canvas/85 backdrop-blur-md">
        ...
        <div className="border-t border-line/70 bg-surface-tinted/60">
          <div className="mx-auto flex max-w-content flex-wrap items-center gap-1 px-6 py-2">
            <ModuleNav links={modules.map((m) => ({ label: m.label, href: m.href }))} />
            {canAdmin && (
