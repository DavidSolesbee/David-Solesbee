...
export const PERMISSIONS: PermissionDef[] = [
  ...
  },
  {
    ...
    description:
      "Manage multiple client organizations at the platform level (cross-tenant). Distinct from a customer administrator, whose admin rights are limited to their own organization.",
  },
  // Modules
  ...
  { key: "module.accounting", category: "module", label: "Accounting", description: "View the accounting analytics module." },
  // Features
  ...
  { key: "feature.accounting_overview", category: "feature", label: "Accounting overview", description: "See the accounting executive snapshot." },
  { key: "feature.accounting_statements", category: "feature", label: "Accounting statements", description: "See departmental operating contribution statements." },
  { key: "feature.view_ar", category: "feature", label: "View AR", description: "See customer accounts receivable totals and queue." },
  { key: "feature.view_ar_detail", category: "feature", label: "View AR detail", description: "See AR credit limits, payment dates, and utilization." },
  { key: "feature.view_ap", category: "feature", label: "View AP", description: "Open the accounts payable area (source data may be unavailable)." },
  { key: "feature.view_gl", category: "feature", label: "View general ledger", description: "See the general-ledger analytics area when released." },
  { key: "feature.view_cash", category: "feature", label: "View cash and banking", description: "See the cash and banking area when released." },
  { key: "feature.view_inventory_accounting", category: "feature", label: "View inventory accounting", description: "See inventory accounting analytics when released." },
  { key: "feature.view_dept_performance", category: "feature", label: "View department performance", description: "See departmental accounting comparisons when released." },
  { key: "feature.view_close", category: "feature", label: "View month-end close", description: "See the month-end close center (source-backed tasks only)." },
  { key: "feature.view_exceptions", category: "feature", label: "View accounting exceptions", description: "See the accounting exception center." },
  { key: "feature.view_health", category: "feature", label: "View accounting health", description: "See the partial accounting health score." },
...
const ALL_FEATURES = [
  ...
  "feature.accounting_overview",
  "feature.accounting_statements",
  "feature.view_ar",
  "feature.view_ar_detail",
  "feature.view_ap",
  "feature.view_gl",
  "feature.view_cash",
  "feature.view_inventory_accounting",
  "feature.view_dept_performance",
  "feature.view_close",
  "feature.view_exceptions",
  "feature.view_health",
